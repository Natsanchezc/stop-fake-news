def col_adjustments(df, cols_to_clean = None, new_order = None, dic = None):   
    # None por defecto para que no de error si no queremos usar alguno de estos parametros
    # le pasamos un dataframe, una lista de columnas a limpiar, una lista con el orden en que queremos que esten, y un diccionario donde las claves son las columnas que queremos cambiar de tipo y los valores los nuevos tipos que queremos
